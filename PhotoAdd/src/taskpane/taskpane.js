var BACKENDURL="https://lampptdemo.blob.core.windows.net/upload/imageupload.html";
var BACKENDFOLDER="https://lampptdemo.blob.core.windows.net/upload/"
...
async function pasteImage() {
  counter++;
  var url = BACKENDFOLDER + id;
  document.getElementById("debug").innerHTML=counter + "<br>" + id;

  toDataURL(url, function(dataUrl) {
    // document.getElementById("debug").innerHTML="LOAD";
    if (dataUrl.length<500 && counter<120)
    {
      window.setTimeout(pasteImage,1000);
      return
    }
    var p = dataUrl.indexOf("base64,");
    var image = dataUrl.substr(p + 7);
